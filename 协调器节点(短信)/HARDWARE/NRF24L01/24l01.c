...
const u8 RX_ADDRESS[TX_ADR_WIDTH]={0x34,0x43,0x10,0x10,0x011}; //发送地址
const u8 RX_ADDRESSS1[RX_ADR_WIDTH]={0x11,0x11,0x11,0x11,0x11}; //发送地址
...
void NRF24L01_RX_Mode(void)
{
  ...
  NRF24L01_Write_Buf(NRF_WRITE_REG+RX_ADDR_P1,(u8*)RX_ADDRESSS1,RX_ADR_WIDTH);//写RX节点地址
	
  NRF24L01_Write_Reg(NRF_WRITE_REG+EN_AA,0x03);    //使能通道0,1的自动应答    
  NRF24L01_Write_Reg(NRF_WRITE_REG+EN_RXADDR,0x03);//使能通道0，1的接收地址  	   
